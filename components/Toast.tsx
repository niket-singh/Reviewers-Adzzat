...
export default function Toast({ message, type, onClose, duration = 3000 }: ToastProps) {
  ...
  return (
    <div className="fixed top-4 right-4 z-50 animate-slide-in-right">
      <div
        className={`${styles[type]} px-6 py-4 rounded-2xl shadow-2xl flex items-center gap-3 min-w-[320px] backdrop-blur-lg bg-opacity-95 transform transition-all duration-300 hover:scale-105`}
      >
